...
const education = () => {
  return (
    <Auxillary>
      ...
      <p>This was my Honours project; I worked in a team of 2 and I was responsible for semi-automatically generating a star-schema from flat relational and NoSQL databases.</p>
      <p>Java was the core language used for this project. I used it to semi-automatically develop the star-schema from both SQL and MongoDB databases. I also defined the ETL process and scripted the entire data pipeline from the source databases to the warehouse containing the generated star-schema.</p>
